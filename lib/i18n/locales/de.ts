export default {
  ...
  folders: {
    ...
    addTaskInline: 'Aufgabe hinzufügen',
    fromSubfolders: 'Aus Unterordnern',
  },
  fab: {
    addFolder: '+ Ordner',
    addTodo: '+ Aufgabe',
  ...
  folderModal: {
    ...
    lockLabel: 'Diesen Ordner sperren',
    lockHint: 'Zum Öffnen ist Code, FaceID oder Fingerabdruck nötig.',
    webAuthNote: 'In der Web-Vorschau wird dies simuliert (kein echter biometrischer Schutz).',
    unlockPrompt: '"{{name}}" entsperren',
    lockedTitle: '"{{name}}" ist gesperrt',
    unlockDenied: 'Entsperren fehlgeschlagen.',
  ...
  banner: {
    ...
    dynamicQuote_one: 'Erledige die kürzeste Aufgabe ({{minutes}} Min) und schaffst {{percent}}% deiner heutigen Liste!',
    dynamicQuote_other: 'Erledige die {{count}} kürzesten Aufgaben ({{minutes}} Min) und schaffst {{percent}}% deiner heutigen Liste!',
    quotes: [
      ...
      'Ein aufgeräumter Kopf beginnt mit einer aufgeräumten Liste.',
      'Fünf Minuten Anfangen schlagen eine Stunde Aufschieben.',
      'Du bist näher am Ziel, als du denkst.',
      'Erledigt ist besser als perfekt.',
      'Heute zählt, was du wirklich tust – nicht was du planst.',
      'Ein Haken auf der Liste ist ein Gewinn im Kopf.',
      'Manchmal ist der erste Schritt schon die halbe Miete.',
      'Du brauchst keinen perfekten Moment, nur einen Anfang.',
    ],
  },
  now: {
  ...
  settings: {
    ...
    tabBarColorLabel: 'Farbe der Tableiste',
    tabBarColorInfo: 'Legt die Farbe fest, in der das ausgewählte Symbol in der unteren Tableiste erscheint. "Auto" richtet sich immer nach deiner Akzentfarbe.',
    starPositionLabel: 'Position des Sterns',
    starPositionLeft: 'Links',
    starPositionRight: 'Rechts',
    starPositionInfo: 'Legt fest, ob in der Aufgabenliste die Erledigt-Checkbox oder der Fokus-Stern links bzw. rechts steht.',
    defaultFolderLabel: 'Startordner',
    defaultFolderInfo: 'Legt fest, was beim Öffnen des Ordner-Tabs zuerst angezeigt wird — "Alle ToDos" oder ein bestimmter Ordner.',
